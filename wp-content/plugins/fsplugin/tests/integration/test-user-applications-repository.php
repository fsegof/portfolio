...
class User_Applications_Repository_Test extends Plugin_Test_Case {
	/**
	 * @var \FSPortfolio\User_Applications_Repository
	 */
	...
	public function set_up() {
		parent::set_up();
		$this->user_applications_repository = new \FSPortfolio\User_Applications_Repository();
	}

	/**
	 * Returns user application for testing.
	 * @return \FSPortfolio\User_Application
	 */
	private function get_test_user_application() {
		$user_application                    = new \FSPortfolio\User_Application();
